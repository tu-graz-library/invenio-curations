...
from .diff import DiffProcessorBase
...
class CommentProcessor:
    ...
    def _update_existing_comment(
        self,
        new_data: str,
        crt_comment_event: _generic_dict,
    ) -> None:
    ...
    def _compute_diff_and_update_event(
        ...
        new_data: _generic_dict,
        msg: str,
        errors: list[_generic_dict] | None,  # noqa: ARG002
    ) -> None:
    ...
    def process_comment(
        ...
        new_data: _generic_dict,
        current_draft: _generic_dict,
        errors: list[_generic_dict] | None,
    ) -> None:
